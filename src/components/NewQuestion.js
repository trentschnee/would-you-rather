...
class NewQuestion extends Component {
  ...
  return (cQuestionId === "optionOne" ? (this.setState({optionOne:cQuestionValue})) : (this.setState({optionTwo:cQuestionValue})) )
...
render(){
    ...
    return( <form onSubmit={this.handleSubmit}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={12}>
          <TextField required id="questTwo" label="Enter Question Two Text Here" fullWidth  onChange={this.handleChange} value={optionTwo} />
        </Grid>
        <Grid item xs={12}>
